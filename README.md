...
If your files are contained in a solution (for ease of unit testing, for example), then you just need to point to that solution root folder (where the `.sln` file lives) in the `custom` section of your config file (YAML shown):
